...
// const dayOfWeek = "thursday".toLowerCase();
    ...
    case "/":
        ...
        case null:
            if (operator !== true) {
                ...
                alert("Incorrect operator. Please, chose one of those: (+, -, *, /).");
                
            }

    default:
        console.log("Reload the page to select an option once again.");
}